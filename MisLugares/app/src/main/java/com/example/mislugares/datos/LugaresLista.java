...
public class LugaresLista implements RepositorioLugares
{
    ...
    public void anyadeEjemplos() //Este método no está en RepositorioLugares
    {
        ...
        anyade(new Lugar("SEGAINVEX",
                "C/James Watt , 4 28029 Madrid (SPAIN)", -0.166093, 38.995656,
                TipoLugar.EDUCACION, 0, "",
                "Donde trabajo", 3));
    }
}
