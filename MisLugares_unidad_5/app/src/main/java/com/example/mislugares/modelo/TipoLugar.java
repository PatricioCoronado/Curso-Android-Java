...
public enum TipoLugar
{
    ...
    public static String[] getNombres()
    {
        ...
        //static values devuelve un array con los valores enum
        for (TipoLugar tipo : TipoLugar.values())//Va recorriendo el array en cada bucle
        {//para cada item del enum lo copia en "tipo" y pone el campo texto en el array result
